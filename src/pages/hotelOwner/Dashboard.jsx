...
const Dashboard = () => {
  ...
  return (
    <div>
        <Title align='left' font='Outfit' tittle='Dashboard' subTitle='Monitor your room listings, track bookings and  analyze revenue-all in one place. Stay updated with real-time insights to ensure smooth operations.'/> 
                ...
                <th className='py-3 px-4 text-gray-800 font-medium'>User Name</th>
                 ...
                 max-sm:hidden'>Room Name</th>
                  ...
                  text-center'>Total Amount</th>
                   <th className='py-3 px-4 text-gray-800 font-medium
                   text-center'>Paymenyt Status</th>
            </tr>
