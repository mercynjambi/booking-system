...
const AddRoom = () => {
  ...
  return (
    <form>
        <Title align='left' font='Outfit' title="Add Room" subTitle='Fill in the details carefully and accurrate room details, pricing, and amenities, to enhance the user booking experience.'/>
    ...
    <div className='flex flex-col flex-wrap mt-1 text-gray-400 max-w-sm'>
        {Object.keys(inputs.amenities).map((amenity, index)=>(
           <div key={index}>
            ...
            checked={inputs.amenities[amenity]} onChange={()=> setInputs({...inputs, amenities: {...inputs.amenities, [amenity] : !inputs.amenities[amenity]}})}/>
